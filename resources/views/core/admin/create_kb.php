...
if (isset($_POST['add_kb'])) {
    ...
    $query = "INSERT INTO knowledge_base (kb_id, kb_title, kb_desc) VALUES (?,?,?)";
    $stmt = $mysqli->prepare($query);
    $rc = $stmt->bind_param('sss', $kb_id, $kb_title, $kb_desc);
    $stmt->execute();
    if ($stmt) {
        $success = "Knowledge Base Created" && header("refresh:1; url=create_kb.php");
    } else {
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Add Knowlegde Base</span></li>
                            </ol>
                        </nav>
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                <div class="form-row mb-4">
                                    <div style="display:none" class="form-group col-md-6">
                                        <label for="inputEmail4">KB Id</label>
                                        <input type="text" name="kb_id" value="<?php echo $kb_id; ?>" class="form-control">
                                    </div>
                                </div>
                                <div class="form-row mb-4">
                                    <div class="form-group col-md-12">
                                        <label for="inputEmail4">Knowledge Base Title</label>
                                        <input required type="text" name="kb_title" class="form-control">
                                    </div>
                                </div>
                                <div class="form-row mb-4">
                                    <div class="form-group col-md-12">

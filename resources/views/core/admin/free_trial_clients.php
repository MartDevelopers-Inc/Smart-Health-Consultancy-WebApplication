                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Manage Free Trial Clients</span></li>
                            </ol>
                        </nav>
                        ...
                        <div class="widget-content widget-content-area br-6">
                            ...
                            <div class="table-responsive mb-4 mt-4">
                                <table id="zero-config" class="table table-hover" style="width:100%" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
                                        $ret = "SELECT * FROM `members` WHERE member_package = 'Free Trial' ";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="badge outline-badge-success" href="update_client.php?update=<?php echo $row->member_id; ?>">Upgrade Package</a>
                                                </td>
                                            </tr>
                                        <?php
                                        } ?>

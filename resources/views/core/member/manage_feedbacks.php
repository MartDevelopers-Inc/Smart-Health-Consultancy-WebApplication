...
if (isset($_GET['delete'])) {
    ...
    $stmt->close();
    if ($stmt) {
        $success = "Deleted" && header("refresh:1; url=manage_feedbacks.php");
    } else {
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Manage Feedbacks</span></li>
                            </ol>
                        </nav>
                            ...
                            <div class="table-responsive mb-4 mt-4">
                                <table id="zero-config" class="table table-hover" style="width:100%" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        $ret = "SELECT * FROM `feedbacks` WHERE member_id = '$member_id' ";

                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Consultations</span></li>
                            </ol>
                        </nav>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="badge outline-badge-success" href="add_client_consultation.php?doc_id=<?php echo $row->doc_id; ?>&doc_name=<?php echo $row->doc_name; ?>">Add Consultation</a>
                                                </td>
                                            </tr>
                                        <?php
                                        } ?>

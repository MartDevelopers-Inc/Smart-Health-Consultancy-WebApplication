                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>View Consultations</span></li>
                            </ol>
                        </nav>
                            ...
                            <div class="row layout-spacing">
                                    ...
                                    <div class="user-profile layout-spacing">
                                        <div class="widget-content widget-content-area">
                                            <div class="d-flex justify-content-between">
                                                <h3 class=""><?php echo $row->consul_code; ?></h3>
                                            </div>
                                ...
                                <div class="col-xl-8 col-lg-6 col-md-7 col-sm-12 layout-top-spacing">
                                    ...
                                    <div class="bio layout-spacing ">
                                        <div class="widget-content widget-content-area">
                                            <h3 class="">Consultation Record Number : <span class="badge outline-badge-success"><?php echo $row->consul_code; ?></span></h3>
                                            <p>

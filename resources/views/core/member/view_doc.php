                        ...
                        <div class="page-header">
                            ...
                            <nav class="breadcrumb-one" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">Medical Experts</a></li>
                                    ...
                                    <div class="user-info-list">
                                        ...
                                        <div class="">
                                            <ul class="contacts-block list-unstyled">
                                                ...
                                                <hr>
                                                <li class="contacts-block__item">
                                                    <a href="add_client_consultation.php?doc_id=<?php echo $row->doc_id; ?>&doc_name=<?php echo $row->doc_name; ?>" class='badge outline-badge-primary'>Consult <?php echo $row->doc_name;?></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>

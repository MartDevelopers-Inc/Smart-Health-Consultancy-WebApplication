                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="badge outline-badge-primary" href="update_consultation.php?update=<?php echo $row->consul_id; ?>">Update</a>
                                                    <a class="badge outline-badge-danger text-danger" href="manage_consultations.php?delete=<?php echo $row->consul_id; ?>">Delete</a>
                                                </td>
                                            </tr>
                                        <?php
                                        } ?>

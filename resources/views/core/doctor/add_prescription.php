                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="badge outline-badge-primary" href="new_prescription.php?consul_id=<?php echo $row->consul_id; ?>&status=Prescribed&member_id=<?php echo $row->member_id; ?>">Add Prescription</a>
                                                </td>
                                            </tr>
                                        <?php
                                        } ?>

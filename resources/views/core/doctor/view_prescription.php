                                ...
                                <div class="row layout-spacing">
                                        ...
                                        <div class="user-profile layout-spacing">
                                            <div class="widget-content widget-content-area">
                                                <div class="d-flex justify-content-between">
                                                    <h3 class=""><?php echo $consultation->consul_code; ?></h3>
                                                </div>
                                                    ...
                                                    <div class="">
                                                        <ul class="contacts-block list-unstyled">
                                                            <li class="contacts-block__item">
                                                                ...
                                                                </svg><?php echo date('d M Y g:i', strtotime($consultation->created_at)); ?>
                                                            </li>
                                                            <li class="contacts-block__item">
                                    ...
                                    <div class="col-xl-8 col-lg-6 col-md-7 col-sm-12 layout-top-spacing">
                                        ...
                                        <div class="bio layout-spacing ">
                                            <div class="widget-content widget-content-area">
                                                <h3 class="">Consultation Record Number : <span class="badge outline-badge-success"><?php echo $consultation->consul_code; ?></span></h3>
                                                <p>
                                                    <?php echo $consultation->consul_details; ?>
                                                </p>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 col-xl-6 col-lg-12 mb-xl-0 mb-0 ">
                                                            ...
                                                            <div class="d-flex b-skills">
                                                                ...
                                                                <div class="">
                                                                    <h5>Doctor Phone Number</h5>
                                                                    <p class="text-primary">
                                                                        <?php echo $doctor->doc_phone; ?>
                                                                    </p>
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 layout-top-spacing">
                                        ...
                                        <div class="bio layout-spacing ">
                                            <div class="widget-content widget-content-area">
                                                ...
                                                <h3 class="">Prescription Record Number : <span class="badge outline-badge-primary"><?php echo $prescriptions->pre_code; ?></span></h3>
                                                <p>
                                                    <?php echo $prescriptions->prescription; ?>
                                                </p>
                                            </div>
                                        </div>

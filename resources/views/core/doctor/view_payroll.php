                                                ...
                                                <li class="nav-item">
                                                    <div class="nav-link list-actions" id="invoice-00001" data-invoice-id="00001">
                                                        <div class="f-m-body">
                                                            ...
                                                            <div class="f-body">
                                                                <p class="invoice-number">Payroll <?php echo $row->payroll_code; ?></p>
                                                                <p class="invoice-customer-name"><span>To:</span> <?php echo $row->doc_name; ?></p>
                                                            ...
                                                            <div class="company-info">
                                                                ...
                                                                while ($row = $res->fetch_object()) {
                                                                    if ($row->doc_photo == '') {
                                                                        ...
                                                                        echo   "<img src='../admin/assets/img/paramedics/$row->doc_photo' class='img-fluid img-thumbnail' alt='avatar'>";
                                                                    } ?>
                                                                <?php
                                                                } ?>
                                                            </div>
                                                    ...
                                                    ?>
                                                        <div class="row inv--detail-section">
                                                            ...
                                                            <div class="col-sm-7 align-self-center">
                                                                <p class="inv-to">Payroll From Smart Health Consultancy</p>
                                                            </div>
                                                            <div class="col-sm-5 align-self-center  text-sm-right order-sm-0 order-1">
                                                                <p class="inv-detail-title">To : <?php echo $row->doc_name; ?></p>
                                                                <p class="inv-detail-title">Number : <?php echo $row->doc_number; ?></p>
                                                                <p class="inv-detail-title">Email : <?php echo $row->doc_email; ?></p>
                                                            </div>

                                                            <div class="col-sm-7 align-self-center">
                                                                <p class="inv-street-addr">127 001 Localhost</p>
                                                                <p class="inv-email-address">mail@smarthealthconsultancy.com</p>
                                                            </div>
                                                            <div class="col-sm-5 align-self-center  text-sm-right order-2">
                                                                <p class="inv-list-number"><span class="inv-title">Payroll Number : </span> <span class="inv-"><?php echo $row->payroll_code; ?></span></p>
                                                                    ...
                                                                    <table class="table">
                                                                        <thead class="">
                                                                            <tr>
                                                                                ...
                                                                                <th class="text-right" scope="col">Month Paid</th>
                                                                                <th class="text-right" scope="col">Salary</th>
                                                                            </tr>
                                                                        </thead>
                                                                        <tbody>
                                                                            <tr>
                                                                                <td><?php echo $row->payroll_code; ?></td>
                                                                                <td class="text-right"><?php echo $row->payroll_month; ?></td>
                                                                                <td class="text-right">KSH <?php echo $row->payroll_salary; ?></td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </div>
                                                                ...
                                                                <div class="inv--total-amounts text-sm-right">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-4 col-5">
                                                                            <p class="">Ksh <?php echo $row->payroll_salary; ?></p>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-4 col-5 grand-total-amount">
                                                                            <h4 class="">Ksh <?php echo $row->payroll_salary; ?></h4>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="inv--thankYou">
                                        <div class="row">
                                            <div class="col-sm-12 col-12">
                                                <p class="">Thank You For Being Loyal Smart Health Consultancy Medical Expert.</p>
                                            </div>
                                        </div>
                                    </div>

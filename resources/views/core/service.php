            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 sin_service">
                        ...
                        <div class="ht__sin__solve pt--70">
                            <div class="ser_icon">
                                <img src="images/service/icon/ser-cion-5.png" alt="services Icon">
                            </div> 
                            <div class="ser__content">
                                <h4><a href="single-services.html">Heart Medicine</a></h4>
                                <p>Perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque dantium, totam rem aperiam, eaque</p>
                            </div>
                        </div>
                        <!-- End Single Items -->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 sin_service">
                        ...
                        <div class="ht__sin__solve pt--70">
                            <div class="ser_icon">
                                <img src="images/service/icon/ser-cion-6.png" alt="services Icon">
                            </div> 
                            <div class="ser__content">
                                <h4><a href="single-services.html">Neuro Medicine</a></h4>
                                <p>Perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque dantium, totam rem aperiam, eaque</p>
                            </div>
                        </div>
                        <!-- End Single Items -->
